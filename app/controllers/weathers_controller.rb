class WeathersController < ApplicationController
  ...
  private
    ...
    def weather_params
      params.require(:weather).permit(:time, :indoor_temp, :outdoor_temp, :dewpoint, :wind_speed, :relative_rain, :wind_direction, :indoor_humidity, :outdoor_humidity, :relative_pressure, :wind_chill, :gust_speed, :total_rain)
    end
end
